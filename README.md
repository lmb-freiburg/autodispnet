...
## Running networks
* Change your directory to the network directory (Eg: autodispnet/nets/CSS)
...
* The output is stored in as binary file with a `.float3` extension (Information on reading the output is [here](https://github.com/lmb-freiburg/netdef_models/blob/master/README.md)).
